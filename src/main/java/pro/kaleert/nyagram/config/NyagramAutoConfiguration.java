package pro.kaleert.nyagram.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import pro.kaleert.nyagram.client.AdvancedMultipartBuilder;
...
import pro.kaleert.nyagram.core.concurrency.DefaultConcurrencyStrategy;
import pro.kaleert.nyagram.core.concurrency.NyagramExecutor;
import pro.kaleert.nyagram.core.impl.DefaultMissingArgumentHandler;
import pro.kaleert.nyagram.core.polling.NyagramPoller;
...
import pro.kaleert.nyagram.feature.forum.impl.InMemoryTopicIdCache;
import pro.kaleert.nyagram.feature.forum.spi.TopicIdCache;
import pro.kaleert.nyagram.security.spi.UserLevelProvider;
import pro.kaleert.nyagram.security.spi.UserPermissionProvider;
import pro.kaleert.nyagram.webhook.NyagramWebhookController;
import pro.kaleert.nyagram.webhook.WebhookLifecycleService;
 ...
 * <ul>
 *     <li>Создает {@link pro.kaleert.nyagram.client.NyagramClient}.</li>
 *     <li>Настраивает {@link pro.kaleert.nyagram.core.polling.NyagramPoller} или Webhook контроллер.</li>
...
@Slf4j
@Configuration
@ComponentScan(basePackages = "pro.kaleert.nyagram")
...
public class NyagramAutoConfiguration {
    ...
    **/
    ...
    public WebhookLifecycleService webhookLifecycleService(
            ...
            ObjectProvider<NyagramBotProvider> nyagramBotProvider) {
        return new WebhookLifecycleService(client, config, nyagramBotProvider);
    }
