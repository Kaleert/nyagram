...
import pro.kaleert.nyagram.client.proxy.DynamicProxyClientHttpRequestFactory;
import pro.kaleert.nyagram.client.proxy.NyagramProxyProvider;
import pro.kaleert.nyagram.client.proxy.ProxyAuthenticator;
...
public class NyagramConfig {
     ...
     * <p>
     * В основном используется компонентом {@link pro.kaleert.nyagram.core.polling.NyagramPoller}
