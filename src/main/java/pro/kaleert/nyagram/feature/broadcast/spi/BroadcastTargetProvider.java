package pro.kaleert.nyagram.feature.broadcast.spi;
 ...
 * <p>
 * Пользователь библиотеки должен реализовать этот интерфейс, чтобы указать {@link pro.kaleert.nyagram.feature.broadcast.BroadcastManager},
