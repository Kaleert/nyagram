...
import pro.kaleert.nyagram.core.registry.EventRegistry;
import pro.kaleert.nyagram.client.NyagramClient;
import pro.kaleert.nyagram.event.EventType;
 ...
 * помеченные аннотацией {@link pro.kaleert.nyagram.event.NyagramEventHandler}.
 * </p>
 *
 * @since 1.0.0
 */
...
public class EventDispatcher {
     ...
     * <p>
     * Определяет тип события ({@link pro.kaleert.nyagram.event.EventType}), находит
