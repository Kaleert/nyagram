...
import pro.kaleert.nyagram.fsm.annotation.SessionData;
 ...
 * <p>
 * Отвечает за инъекцию параметров в методы, помеченные аннотацией {@link pro.kaleert.nyagram.fsm.annotation.StateAction}.
