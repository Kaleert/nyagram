package pro.kaleert.nyagram.fsm.spi;
 ...
 * Реализации могут хранить данные в памяти ({@link pro.kaleert.nyagram.fsm.store.InMemorySessionStore}),
 * в Redis ({@link pro.kaleert.nyagram.fsm.store.RedisSessionStore}) или в SQL базе данных.
 * </p>
 *
 * @since 1.0.0
 */
