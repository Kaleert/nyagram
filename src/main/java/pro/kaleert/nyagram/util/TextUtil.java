package pro.kaleert.nyagram.util;
...
public class TextUtil {
    ...
    /**
     * Создает стандартную цитату (Blockquote).
     *
     * @param text Текст цитаты.
     * @return Строка {@code <blockquote>text</blockquote>}.
     *
     * @since 1.2.1
     */
    ...
    /**
     * Создает сворачиваемую цитату (Expandable Blockquote) (API 7.3+).
     * <p>
     * Идеально подходит для длинных текстов, FAQ или логов. Пользователь увидит
     * только первые строки, а остальное развернется по клику.
     * </p>
     *
     * @param text Текст длинной цитаты.
     * @return Строка {@code <blockquote expandable>text</blockquote>}.
     *
     * @since 1.2.1
     */
    public static String expandableBlockquote(String text) {
