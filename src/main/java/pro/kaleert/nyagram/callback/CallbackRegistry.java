package pro.kaleert.nyagram.callback;

import pro.kaleert.nyagram.callback.annotation.Callback;
 ...
 * <p>
 * Сканирует бины Spring на наличие методов, помеченных аннотацией {@link pro.kaleert.nyagram.callback.annotation.Callback},
