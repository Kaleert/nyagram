...
import pro.kaleert.nyagram.validation.Validation;
import pro.kaleert.nyagram.pipeline.*;
 ...
 * <p>
 * Проверяет входные параметры метода на соответствие аннотациям {@link pro.kaleert.nyagram.validation.Validation}
 * (длина, regex и т.д.) и {@link pro.kaleert.nyagram.command.CommandArgument} (обязательность).
...
public class ValidationMiddleware implements CommandPreProcessor {
            ...
            int requiredParamsCount = (int) parameters.stream()
                    ...
                    .filter(p -> {
                        pro.kaleert.nyagram.command.CommandArgument argAnn = 
                            p.getAnnotation(pro.kaleert.nyagram.command.CommandArgument.class);
    ...
    private boolean isContextParameter(Parameter param) {
        ...
        return type.isAssignableFrom(CommandContext.class) ||
               type.isAssignableFrom(pro.kaleert.nyagram.api.objects.Update.class) ||
               type.isAssignableFrom(pro.kaleert.nyagram.api.objects.message.Message.class) ||
               type.isAssignableFrom(pro.kaleert.nyagram.api.objects.User.class) ||
               type.isAssignableFrom(pro.kaleert.nyagram.client.NyagramClient.class);
    }
    ...
    private String getParameterName(Parameter parameter) {
        pro.kaleert.nyagram.command.CommandArgument argAnn = 
            parameter.getAnnotation(pro.kaleert.nyagram.command.CommandArgument.class);
