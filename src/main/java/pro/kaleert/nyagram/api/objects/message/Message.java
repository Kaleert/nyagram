...
import pro.kaleert.nyagram.api.objects.forum.ForumTopic;
import pro.kaleert.nyagram.api.objects.games.Game;
import pro.kaleert.nyagram.api.objects.payments.Invoice;
import pro.kaleert.nyagram.api.objects.payments.SuccessfulPayment;
import pro.kaleert.nyagram.api.objects.polls.Poll;
import pro.kaleert.nyagram.api.objects.stickers.Sticker;
import pro.kaleert.nyagram.api.objects.system.*;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.VideoChatScheduled;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.VideoChatStarted;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.VideoChatEnded;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.VideoChatParticipantsInvited;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.ForumTopicClosed;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.ForumTopicReopened;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.ForumTopicEdited;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.GeneralForumTopicHidden;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.GeneralForumTopicUnhidden;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.MessageAutoDeleteTimerChanged;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.WriteAccessAllowed;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.ChatBoostAdded;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.GiveawayCreated;
import pro.kaleert.nyagram.api.objects.system.SystemMessages.GiveawayCompleted;
import pro.kaleert.nyagram.api.objects.giveaway.Giveaway;
import pro.kaleert.nyagram.api.objects.giveaway.GiveawayWinners;
import pro.kaleert.nyagram.api.objects.gifts.GiftInfo;
import pro.kaleert.nyagram.api.objects.passport.PassportData;
import pro.kaleert.nyagram.api.objects.message.origin.MessageOrigin;
import pro.kaleert.nyagram.api.objects.managedbots.ManagedBotCreated;
import pro.kaleert.nyagram.api.objects.webapp.WebAppData;
import pro.kaleert.nyagram.api.objects.replykeyboard.InlineKeyboardMarkup;
import pro.kaleert.nyagram.api.objects.polls.PollOptionAdded;
import pro.kaleert.nyagram.api.objects.polls.PollOptionDeleted;
...
public record Message(
    ...
    @JsonProperty("paid_media") pro.kaleert.nyagram.api.objects.media.PaidMediaInfo paidMedia,
    
    /** Уведомление о возврате платежа. */
    @JsonProperty("refunded_payment") pro.kaleert.nyagram.api.objects.payments.RefundedPayment refundedPayment,
    ...
    /** Количество звезд, уплаченных отправителем за это сообщение. */
    @JsonProperty("paid_star_count") Integer paidStarCount,

    /** Служебное сообщение: Изменилась цена отправки платного сообщения в чат. */
    @JsonProperty("paid_message_price_changed") pro.kaleert.nyagram.api.objects.system.SystemMessages.PaidMessagePriceChanged paidMessagePriceChanged
    ...
    public pro.kaleert.nyagram.api.objects.media.PaidMediaInfo getPaidMedia() { return paidMedia; }
    public pro.kaleert.nyagram.api.objects.payments.RefundedPayment getRefundedPayment() { return refundedPayment; }
