...
public class SystemMessages {
    ...
    public record GiveawayCompleted(
        ...
        @JsonProperty("giveaway_message") pro.kaleert.nyagram.api.objects.message.Message giveawayMessage
    ) implements BotApiObject {}
    
    /**
     * Служебное сообщение: Изменена цена отправки сообщений в чат.
     * @since 1.2.1
     */
    @JsonIgnoreProperties(ignoreUnknown = true)
