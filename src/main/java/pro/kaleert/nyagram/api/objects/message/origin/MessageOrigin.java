package pro.kaleert.nyagram.api.objects.message.origin;
...
@JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = MessageOrigin.UnknownMessageOrigin.class 
)
@JsonSubTypes({
...
public sealed interface MessageOrigin extends BotApiObject 
    permits MessageOrigin.MessageOriginUser, MessageOrigin.MessageOriginHiddenUser, 
            MessageOrigin.MessageOriginChat, MessageOrigin.MessageOriginChannel, 
            MessageOrigin.UnknownMessageOrigin {
