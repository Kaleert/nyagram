package pro.kaleert.nyagram.api.objects.inlinequery.result;

import com.fasterxml.jackson.annotation.JsonProperty;
import pro.kaleert.nyagram.api.objects.inlinequery.inputmessagecontent.InputMessageContent;
...
public record InlineQueryResultArticle(
    ...
    public static InlineQueryResultArticle simple(String id, String title, String messageText) {
        return InlineQueryResultArticle.builder()
                .id(id)
                .title(title)
                .inputMessageContent(pro.kaleert.nyagram.api.objects.inlinequery.inputmessagecontent.InputTextMessageContent.of(messageText))
                .build();
    }
}