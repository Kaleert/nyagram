...
import pro.kaleert.nyagram.api.objects.webapp.WebAppInfo;
import pro.kaleert.nyagram.api.objects.LoginUrl; 
import pro.kaleert.nyagram.api.objects.games.CallbackGame;
import pro.kaleert.nyagram.api.objects.inlinequery.SwitchInlineQueryChosenChat;
...
public record InlineKeyboardButton(
     ...
     *
     * @param buttonText Текст, который будет НА кнопке.
     * @param textToCopy Текст, который СКОПИРУЕТСЯ в буфер обмена.
     * @return объект кнопки.
     *
     * @since 1.1.4
     */
