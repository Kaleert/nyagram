...
import pro.kaleert.nyagram.api.objects.commands.BotCommand;
import pro.kaleert.nyagram.api.objects.commands.scope.BotCommandScope;
import lombok.*;
...
public class SetMyCommands extends BotApiMethodBoolean {
     ...
     *
     * @param scope Объект области видимости (например, {@link pro.kaleert.nyagram.api.objects.commands.scope.BotCommandScopeDefault}).
