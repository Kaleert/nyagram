package pro.kaleert.nyagram.api.methods.polls;
...
import pro.kaleert.nyagram.api.objects.polls.InputPollOption;
...
public class SendPoll extends BotApiMethod<Message> {
    ...
    */
    ...
    public void validate() throws TelegramApiValidationException {
        ...
        if ("quiz".equals(type) && correctOptionId == null && (correctOptionIds == null || correctOptionIds.isEmpty())) {
            throw new TelegramApiValidationException("Для викторины нужен хотя бы один правильный ответ (correct_option_id или correct_option_ids)", PATH);
        }
    }
    ...
    /**
     * Список индексов правильных ответов (от 0). Обязательно для quiz с несколькими ответами.
     * @since 1.2.1
     */
    ...
    /**
     * Настраивает опрос как викторину (quiz) с несколькими правильными ответами.
     *
     * @param correctOptionIds Индексы правильных ответов (начиная с 0).
     * @return текущий билдер.
     * @since 1.2.1
     */
    public SendPoll asQuiz(List<Integer> correctOptionIds) {
        this.type = "quiz";
    ...
    /**
     * Разрешает пользователям менять свой выбор после голосования.
     *
     * @return текущий билдер.
     * @since 1.2.1
     */
    public SendPoll allowRevoting() {
        this.allowsRevoting = true;
        return this;
    }
}